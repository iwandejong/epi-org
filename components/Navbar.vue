    ...
    <div>
        ...
        <Dialog v-model:visible="addEmployee" modal header="Add new employee">
            <form @submit.prevent="createAccount">
                <div class="space-y-4">
                    <span class="text-surface-500 dark:text-surface-400 block">An employeeId has been generated. Copy it and share it with the employee.</span>
                    <div class="grid gap-y-4 gap-x-8 *:flex *:items-center *:gap-4">
        
                        <div class="">
                            <label for="firstName" class="font-semibold w-24">Role</label>
                            <InputText id="firstName" class="flex-auto" autocomplete="off" v-model="newEmployee.role" />
                        </div>

                        <div class="">
                            <label for="email" class="font-semibold w-24">Email</label>
                            <InputText id="email" class="flex-auto" autocomplete="off" v-model="newEmployee.email" />
                        </div>

                        <div class="">
                            <label for="manager" class="font-semibold w-24">Direct Line Manager</label>
                        ...
                        <div class="">
                            ...
                            <InputText id="employeeId" class="flex-auto" autocomplete="off" v-model="newEmployee.employeeId" disabled/>
                        </div>
                    </div>
        
                    <div class="flex justify-center gap-2">
                        <Button type="submit" icon="pi pi-copy" label="Copy to Clipboard" severity="primary" @click="addEmployee = false"></Button>
                    </div>
                </div>
            </form>
        </Dialog>
